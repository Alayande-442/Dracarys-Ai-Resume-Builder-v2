...
function InputDialog({
  ...
  async function onSubmit(input: GenerateWorkExperienceInput) {
    try {
      ...
      onWorkExperienceGenerated(formattedResponse);
    } catch (error) {
      console.error(error);
      toast({
        variant: "destructive",
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      {...field}
                      placeholder={`" E.g: I worked as a Software Engineer at Microsoft from March 2021 to July 2023, where I was responsible for..."`}
                      autoFocus
                    />
                  </FormControl>
                  <FormMessage />
